...
public final class Config extends Config_pro {
     ...
     * 业务布局模板
     */
    public static String[] GEO_TB_MODULE = new String[]{"geodb/tb_moudle/property_point.xml"};

    public static String[] GEO_DB_NAME = new String[]{"单株调查.geodatabase"};
    public static String[] GEO_DB_MODULE = new String[]{"geodb/".concat(GEO_DB_NAME[0])};
    /**
     * 系统字典表
     */

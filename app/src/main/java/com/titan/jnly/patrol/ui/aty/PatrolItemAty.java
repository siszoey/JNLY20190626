...
public class PatrolItemAty extends BaseMvpCompatAty implements View.OnClickListener {
    ...
    protected void initClass() {
        easyUiXml = IoXml.readXmlFromAssets(_context, EasyUiXml.class, "patrol/XML_PATROL_MOUDLE.xml");
    ...
    private void beforeFrom() {
        ...
        //------------------------------------------------------------------------------------------
        //养护时间
        UiXml date = easyUiXml.getUiXmlByAlias("巡查时间");
        //养护单位
        UiXml dep = easyUiXml.getUiXmlByAlias("巡查单位");
        //养护人

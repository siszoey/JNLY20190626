package com.titan.jnly.invest.ui.frg;
...
import com.titan.jnly.invest.apt.DataSyncAdapter;
import com.titan.jnly.invest.bean.DataSync;
import com.titan.jnly.invest.ui.aty.DataSyncAtyV1;
import com.titan.jnly.invest.ui.aty.SyncContract;
import com.titan.jnly.invest.ui.aty.SyncPresenter;
...
public class SyncAllFragment
    ...
    public static SyncAllFragment newInstance() {
        Bundle args = new Bundle();
        SyncAllFragment fragment = new SyncAllFragment();
    ...
    public SyncAllFragment setTable(FeatureTable table) {
        this.table = table;
        return this;
    }

    public SyncAllFragment setPageSize(int pageSize, int pageNum) {
    ...
    private void queryData(int pageNum) {
        ...
        params.setWhereClause(DataStatus.SYNC_ALL());

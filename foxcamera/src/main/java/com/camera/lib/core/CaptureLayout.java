...
import com.camera.lib.listener.ReturnListener;
...
public class CaptureLayout extends FrameLayout {
    ...
    public CaptureLayout(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        layout_height = button_size + (button_size / 6) * 2;
...
//                resetCaptureLayout();
    ...
    public ImageView getIvLeft() {
        return iv_custom_left;
    }

    public ImageView getIvRight() {
        return iv_custom_right;
    }

    public void resetIvLeft() {
        iv_custom_left.setImageResource(iconLeft);
    }

    public void resetIvRight() {
        iv_custom_right.setImageResource(iconRight);
    }
}

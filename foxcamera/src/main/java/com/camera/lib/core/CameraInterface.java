...
import com.camera.lib.util.AngleUtil;
import com.camera.lib.util.CameraParamUtil;
import com.camera.lib.util.CheckPermission;
import com.camera.lib.util.DeviceUtil;
...
public class CameraInterface implements Camera.PreviewCallback {
    ...
    public void setToolView(ImageView mLeft, ImageView mRight) {
        this.mLeft = mLeft;
        this.mRight = mRight;
    }
    ...
    private void rotationAnimation() {
        ...
        if (rotation != angle) {
            ...
            List<Animator> anim = new ArrayList<>();
            if (mSwitchView != null) {
            ...
            if (mLeft != null) {
                ObjectAnimator animL = ObjectAnimator.ofFloat(mLeft, "rotation", start_rotaion, end_rotation);
                anim.add(animL);
            }
            if (mRight != null) {
                ObjectAnimator animR = ObjectAnimator.ofFloat(mRight, "rotation", start_rotaion, end_rotation);
                anim.add(animR);
            }
            if (iRotate != null) iRotate.rotate(end_rotation);
...
//        }
    ...
    public void setIRotate(IRotate iRotate) {

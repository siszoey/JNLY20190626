...
public final class ReflectUtil {
    ...
    public static <T> T invoke(Object obj, Method method, Object... objects) {
        try {
    ...
    public static <T> T invoke(Method method, Object... objects) {
        try {
    ...
    public static <T> T invoke(Class clazz, Method method, Object... objects) {
        try {
            Object obj = clazz.newInstance();
            return (T) method.invoke(obj, objects);
        } catch (Exception e) {
    ...
    public static <T> T invokeExp(Class clazz, Method method, Object... objects) throws Exception {
        Object obj = clazz.newInstance();
        return (T) method.invoke(obj, objects);
    }
